...
class Robot
{
  public:    
    ...
    // ------------dameda custom-------------------------
    unsigned long nextTimeHeartbeat ; // wird nicht benötigt!??
    unsigned long nextTimeCheckHeartbeat ;
    // --------------------------------------------------
    Robot();
    // robot setup
    virtual void setup();
    ...
    // other
    virtual void beepBatLow();  // dameda 
    virtual void beepError();   // dameda 
    virtual void beepStartup(); // dameda 
    virtual void beepGoHome();  // dameda 
    virtual void beepRemote();  // dameda 
